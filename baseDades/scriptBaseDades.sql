...
CREATE INDEX `fk_Alumne_has_Idiomes_Alumne1_idx` ON `borsa`.`Alumne_has_Idiomes` (`Alumne_idAlumne` ASC);

CREATE INDEX `fk_Alumne_has_Idiomes_NIvellsIdioma1_idx` ON `borsa`.`Alumne_has_Idiomes` (`NivellsIdioma_idNivellIdioma` ASC);
